...
{
ClientSocket1->Port = EditPort->Text.ToInt(); //Задаем клиенту порт
ClientSocket1->Host = EditHost->Text; //Задаем клиенту хост
ClientSocket1->Active = true; //Включаем клиента
